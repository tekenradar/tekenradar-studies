...
class LBflow_KidsDef extends SurveyDefinition {
  ...
  constructor(isRequired?: boolean) {
    ...
    this.Q12a = new LymeDiagnosis3alt2a(this.key,required, SurveyEngine.multipleChoice.any(this.Q12.key, 't1'));
    this.Q12b = new LymeDiagnosis3alt2b(this.key,required, SurveyEngine.multipleChoice.any(this.Q12.key, 't2'));
    this.Q12c = new LymeDiagnosis3alt2c(this.key,required, SurveyEngine.multipleChoice.any(this.Q12.key, 't3'));
    this.Q12d = new LymeDiagnosis3alt2d(this.key,required, SurveyEngine.multipleChoice.any(this.Q12.key, 't4'));
...
export const LBflow_Kids = new LBflow_KidsDef(applyRequiredQuestions);
