...
import { QuestionsKids1, QuestionsKids2, PHQ_15, Symptoms3, SymptomsText1_Kids, SymptomsText2_Kids, TextQUKids } from './questions/standard';
...
export const T12_Kids = new T12_KidsDef(applyRequiredQuestions);
